...
import (
	...
	poeclient "github.com/furyanrasta/furya/x/poe/client"
...
Example:
	...
	cmd.Flags().String(server.FlagMinGasPrices, fmt.Sprintf("0.000006%s", stakingToken), "Minimum gas prices to accept for transactions; All fees in a tx must meet this minimum (e.g. 0.01fury)")
