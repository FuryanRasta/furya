...
func TestFuryaHandlesDispatchMsg(t *testing.T) {
	var (
		contractAddr = RandomAddress(t)
		otherAddr    = RandomAddress(t)
	)
	specs := map[string]struct {
		setup                 func(m *handlerFuryaKeeperMock)
	...
	for name, spec := range specs {
		t.Run(name, func(t *testing.T) {
			...
			mock := handlerFuryaKeeperMock{}
			consensusStoreMock := NoopConsensusParamsStoreMock()
			spec.setup(&mock)
			h := NewFuryaHandler(cdc, mock, bankMock, consensusStoreMock, govRouter)
...
func TestFuryaHandlesPrivilegeMsg(t *testing.T) {
	myContractAddr := RandomAddress(t)

	var capturedDetails *types.FuryaContractDetails
	captureContractDetails := func(ctx sdk.Context, contract sdk.AccAddress, details *types.FuryaContractDetails) error {
	...
	captureWithMock := func(mutators ...func(*wasmtypes.ContractInfo)) func(mock *handlerFuryaKeeperMock) {
		return func(m *handlerFuryaKeeperMock) {
	...
	specs := map[string]struct {
		...
		expDetails         *types.FuryaContractDetails
		...
		"unregister begin block": {
			...
			setup: captureWithMock(func(info *wasmtypes.ContractInfo) {
				ext := &types.FuryaContractDetails{
					RegisteredPrivileges: []types.RegisteredPrivilege{{Position: 1, PrivilegeType: "begin_blocker"}},
				}
				info.SetExtension(ext)
			}),
			expDetails:         &types.FuryaContractDetails{RegisteredPrivileges: []types.RegisteredPrivilege{}},
		...
		"register begin block with existing registration": {
			src: contract.PrivilegeMsg{Request: types.PrivilegeTypeBeginBlock},
			setup: captureWithMock(func(info *wasmtypes.ContractInfo) {
				info.SetExtension(&types.FuryaContractDetails{
					RegisteredPrivileges: []types.RegisteredPrivilege{{Position: 1, PrivilegeType: "begin_blocker"}},
				})
			}),
		},
	...
	for name, spec := range specs {
		t.Run(name, func(t *testing.T) {
			...
			mock := handlerFuryaKeeperMock{}
			spec.setup(&mock)
			h := NewFuryaHandler(nil, mock, nil, nil, nil)
			var ctx sdk.Context
...
func TestHandleGovProposalExecution(t *testing.T) {
	...
	for name, spec := range specs {
		t.Run(name, func(t *testing.T) {
			...
			h := NewFuryaHandler(cdc, mock, nil, nil, router)
			var ctx sdk.Context
...
func TestHandleMintToken(t *testing.T) {
	...
	specs := map[string]struct {
		...
		setup          func(k *handlerFuryaKeeperMock)
		expErr         *sdkerrors.Error
	...
	for name, spec := range specs {
		t.Run(name, func(t *testing.T) {
			...
			keeperMock := handlerFuryaKeeperMock{}
			spec.setup(&keeperMock)
			h := NewFuryaHandler(cdc, keeperMock, mock, nil, nil)
			var ctx sdk.Context
...
func TestHandleConsensusParamsUpdate(t *testing.T) {
	...
	for name, spec := range specs {
		t.Run(name, func(t *testing.T) {
			...
			keeperMock := handlerFuryaKeeperMock{}
			spec.setup(&keeperMock)
			h := NewFuryaHandler(cdc, keeperMock, nil, mock, nil)
			var ctx sdk.Context
...
func withPrivilegeRegistered(p types.PrivilegeType) func(k *handlerFuryaKeeperMock) {
	return func(k *handlerFuryaKeeperMock) {
		k.GetContractInfoFn = func(ctx sdk.Context, contractAddress sdk.AccAddress) *wasmtypes.ContractInfo {
			c := wasmtypes.ContractInfoFixture(func(info *wasmtypes.ContractInfo) {
				info.SetExtension(&types.FuryaContractDetails{
...
func setupHandlerKeeperMock(m *handlerFuryaKeeperMock, mutators ...func(*wasmtypes.ContractInfo)) {
	m.IsPrivilegedFn = func(ctx sdk.Context, contract sdk.AccAddress) bool {
		return true
	}
	m.GetContractInfoFn = func(ctx sdk.Context, contractAddress sdk.AccAddress) *wasmtypes.ContractInfo {
	...
	m.setContractDetailsFn = func(ctx sdk.Context, contract sdk.AccAddress, details *types.FuryaContractDetails) error {
		return nil
	}
}

var _ FuryaWasmHandlerKeeper = handlerFuryaKeeperMock{}

type handlerFuryaKeeperMock struct {
	...
	setContractDetailsFn          func(ctx sdk.Context, contract sdk.AccAddress, details *types.FuryaContractDetails) error
	GetContractInfoFn             func(ctx sdk.Context, contractAddress sdk.AccAddress) *wasmtypes.ContractInfo
}

func (m handlerFuryaKeeperMock) IsPrivileged(ctx sdk.Context, contract sdk.AccAddress) bool {
...
func (m handlerFuryaKeeperMock) appendToPrivilegedContracts(ctx sdk.Context, privilegeType types.PrivilegeType, contractAddress sdk.AccAddress) (uint8, error) {
...
func (m handlerFuryaKeeperMock) removePrivilegeRegistration(ctx sdk.Context, privilegeType types.PrivilegeType, pos uint8, contractAddr sdk.AccAddress) bool {
...
func (m handlerFuryaKeeperMock) setContractDetails(ctx sdk.Context, contract sdk.AccAddress, details *types.FuryaContractDetails) error {
...
func (m handlerFuryaKeeperMock) GetContractInfo(ctx sdk.Context, contractAddress sdk.AccAddress) *wasmtypes.ContractInfo {
